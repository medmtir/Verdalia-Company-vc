...
export default function DashboardOverviewPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Top Banner */}
      <div className="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <span className="text-xs font-bold uppercase tracking-widest text-verdalia-olive">
            {adminDict.overview.tag}
          </span>
          <h1 className="font-serif text-2xl md:text-3xl font-bold text-verdalia-dark mt-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold text-verdalia-dark mt-1">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex items-center justify-between">
          ...
          <div className="w-12 h-12 rounded-lg bg-emerald-50 text-verdalia-olive flex items-center justify-center">
