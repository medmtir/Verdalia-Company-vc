...
function AdminDashboardInner({
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: adminDict.sidebar.clients,
      icon: Receipt,
    },
    {
  ...
  return (
    ...
    >
      ...
      <aside className="hidden lg:flex lg:flex-col w-72 bg-[#172B13] text-white border-r border-[#24421D] flex-shrink-0 sticky top-0 h-screen overflow-y-auto">
        ...
        {/* App Mobile Install Button */}
        <div className="px-4 py-2 border-t border-[#24421D]">
          <button
            type="button"
            onClick={() => setPwaModalOpen(true)}
            className="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-verdalia-light hover:text-white border border-white/10 transition-all text-xs font-semibold group cursor-pointer"
          >
            <div className="flex items-center gap-2.5">
              <Smartphone className="w-4 h-4 text-verdalia-gold group-hover:scale-110 transition-transform" />
              <span>Installer l&apos;App Mobile</span>
            </div>
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-verdalia-gold/20 text-verdalia-gold font-bold">
              iPhone / Android
            </span>
          </button>
        </div>
          ...
          <div className="relative w-72 bg-[#172B13] text-white flex flex-col h-full z-10">
            ...
            <div className="p-4 border-t border-[#24421D] space-y-2">
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-emerald-900/50 hover:bg-emerald-900/70 text-emerald-200 border border-emerald-600/40 text-xs font-bold transition-colors"
              >
                <div className="flex items-center gap-2.5">
                  <Smartphone className="w-4 h-4 text-verdalia-gold" />
                  <span>Installer l&apos;App Mobile</span>
                </div>
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-verdalia-gold text-black font-bold">
                  iPhone / Android
                </span>
              </button>
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-3 sm:px-6 py-2.5 sm:py-3.5 flex items-center justify-between sticky top-0 z-30 flex-shrink-0 shadow-xs">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            {/* PWA Mobile App Quick Install Button */}
            <button
              type="button"
              onClick={() => setPwaModalOpen(true)}
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-bold text-verdalia-dark hover:text-verdalia-olive bg-gray-50 hover:bg-emerald-50/50 border border-gray-200 transition-all shadow-2xs"
              title="Installer l'application sur iPhone ou Android"
            >
              <Smartphone className="w-3.5 h-3.5 text-verdalia-olive" />
